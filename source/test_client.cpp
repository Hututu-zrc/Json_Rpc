...
void onRpcMessage(const BaseConnection::Ptr &conn, const BaseMessage::Ptr &msg)
{
...
void onTopicMessage(const BaseConnection::Ptr &conn, const BaseMessage::Ptr &msg)
{
...
int main()
{
    ...
    dispatcher->registryCallBack(MType::RSP_TOPIC,onTopicMessage);
    dispatcher->registryCallBack(MType::RSP_RPC,onRpcMessage);
